...
then
	...
	do
		...
		echo "Start encoding..."
		echo "Target rate: ${TAR} kbps"

		#Encoding
		ffmpeg -i ${SRC}.y4m -codec:v ${CODEC} -b:v ${TAR}k -minrate ${TAR}k -maxrate ${TAR}k out_${OUT}.mp4
